...
function usage() {
  console.log(`mcp-permission-matrix v${VERSION}

Usage:
  mcp-permission-matrix --path FILE_OR_DIR
  mcp-permission-matrix FILE_OR_DIR --markdown
  mcp-permission-matrix FILE_OR_DIR --sarif > results.sarif
  mcp-permission-matrix FILE_OR_DIR --annotations
  mcp-permission-matrix FILE_OR_DIR --redact
...
try {
  ...
  console.error(`mcp-permission-matrix: ${error.message}`);
  process.exit(2);
}
